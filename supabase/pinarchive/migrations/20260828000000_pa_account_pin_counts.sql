-- Migration: 20260828000000_pa_account_pin_counts.sql
-- Description: pa_account_pin_counts RPC for live DB pin totals per account + R2 v3 pa_account_pins_page with header sort branches

-- ============================================================================
-- 1. pa_account_pin_counts
-- ============================================================================
CREATE OR REPLACE FUNCTION public.pa_account_pin_counts(p_workspace_id uuid)
RETURNS TABLE (account_id uuid, pins bigint)
...
-- ============================================================================
-- 2. pa_account_pins_page (R2 v3: includes first_seen_at and delta_repins sort)
-- ============================================================================
